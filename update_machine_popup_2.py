...
pattern = r"if\s*\(techM\.isNotEmpty\)\s*\.\.\.\[\s*const\s*SizedBox\(height:\s*4\),\s*Text\(\s*'Machines ajout[^\']+',\s*style:\s*GoogleFonts\.inter\(\s*color:\s*primaryColor,\s*fontSize:\s*11,\s*fontWeight:\s*FontWeight\.w500,\s*\),\s*\),\s*\]"
